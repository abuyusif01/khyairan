...
- [x] Delete button only rendered when isOwner=true in tagList
- [x] Clicking delete shows confirmation with product count warning if products exist
- [x] On confirmation, calls deleteTag and removes row from DOM
